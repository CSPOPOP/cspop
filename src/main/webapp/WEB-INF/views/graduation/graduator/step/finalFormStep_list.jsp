                    ...
                    <div class="pt-lg-18 pb-lg-16 py-12 ">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <h1 class="h2 text-white mb-2">최종보고서</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="offset-lg-1 col-lg-10 col-md-12 col-12">
                        ...
                        <div class="text-xs-center">
                            <ul class="pagination justify-content-center">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item"><a class="page-link"
                                                                 href="/api/graduation/graduate_finalForm?page=0&size=10">처음</a>
                                        </li>
                                        <li class="page-item"><a class="page-link"
                                                                 href="/api/graduation/graduate_finalForm?page=${graduator.number-1}&size=10">이전</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${graduator.pageable.pageNumber+1 == i}">
                                            <li class="page-item disabled"><a class="page-link"
                                                                              href="/api/graduation/graduate_finalForm?page=${i-1}&size=10">${i}</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link"
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item "><a class="page-link"
                                                                  href="/api/graduation/graduate_finalForm?page=${graduator.number+1}&size=10">다음</a>
                                        </li>
                                        <li class="page-item "><a class="page-link"
                                                                  href="/api/graduation/graduate_finalForm?page=${graduator.totalPages-1}&size=10">마지막</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
                    ...
                    <form action="graduate_finalForm.downloadFinalFormStep" method="get" onsubmit="return confirm('다운로드 하시겠습니까?')>
