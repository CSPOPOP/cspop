                ...
                <div class="offset-xl-1 col-xl-10 col-lg-12 col-md-12 col-12">
                    <div class="pt-lg-18 pb-lg-16 py-12 ">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <form action="/api/graduation/interimFormStep/search?page=0&size=10" method="get">
                        ...
                        <div class="text-xs-center">
                            <ul class="pagination justify-content-center">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item"><a class="page-link"
                                                                 href="/api/graduation/graduate_interimForm?page=0&size=10">처음</a>
                                        </li>
                                        <li class="page-item"><a class="page-link"
                                                                 href="/api/graduation/graduate_interimForm?page=${graduator.number-1}&size=10">이전</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${graduator.pageable.pageNumber+1 == i}">
                                            <li class="page-item disabled"><a class="page-link"
                                                                              href="/api/graduation/graduate_interimForm?page=${i-1}&size=10">${i}</a>
                                            </li>
                                        </c:when>
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link"
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="page-item "><a class="page-link"
                                                                  href="/api/graduation/graduate_interimForm?page=${graduator.number+1}&size=10">다음</a>
                                        </li>
                                        <li class="page-item "><a class="page-link"
                                                                  href="/api/graduation/graduate_interimForm?page=${graduator.totalPages-1}&size=10">마지막</a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
