                    ...
                    <c:if test="${fn:contains(userId, 'admin')}">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-arrow dropdown-menu-xl-left">
                                ...
                                <li><a class="dropdown-item" href="/api/graduation/graduate_submitForm?page=0&size=10">신청접수</a></li>
                                <li><a class="dropdown-item" href="/api/graduation/graduate_proposalForm?page=0&size=10">제안서</a></li>
                                <li><a class="dropdown-item" href="/api/graduation/graduate_interimForm?page=0&size=10">중간보고서</a></li>
                                <li><a class="dropdown-item" href="/api/graduation/graduate_finalForm?page=0&size=10">최종보고서</a></li>
                                <li><a class="dropdown-item" href="/api/graduation/graduate_otherForm?page=0&size=10">기타자격</a></li>
                                <li><a class="dropdown-item" href="/api/graduation/graduate_finalPass?page=0&size=10">최종통과</a></li>
                            </ul>
                        </li>
                    </c:if>
                    <c:if test="${fn:contains(userId, 'admin')}">
